...
import { sortByProcessNumber, useProcessSortDir, processNumberSuffix } from "@/lib/processSort";
...
export default function ProcessListPage() {
  ...
  const filtered = sortByProcessNumber(filters.filteredUnsorted, sortDir);
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-4">
          <ProcessFiltersBar filters={filters} sortDir={sortDir} onToggleSort={toggleSort} />
        </CardContent>
      </Card>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <ProcessDueBadges summary={summary} today={today} />
