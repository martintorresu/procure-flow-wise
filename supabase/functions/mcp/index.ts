...
var list_processes_default = defineTool({
  ...
  description: "Lista los procesos de compra visibles para el usuario, con filtros opcionales por tipo o texto de b\xFAsqueda.",
  inputSchema: {
